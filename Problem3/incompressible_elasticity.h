#ifndef EMMA_TOPICS_PROJECT_INCOMPRESSIBLE_ELASTICITY_H
#define EMMA_TOPICS_PROJECT_INCOMPRESSIBLE_ELASTICITY_H
...
#endif //EMMA_TOPICS_PROJECT_INCOMPRESSIBLE_ELASTICITY_H
